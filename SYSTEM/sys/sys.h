...
extern unsigned char Car_Direction; //小车姿势相关的变量
extern float obsatacle0,obsatacle1,obsatacle2,obsatacle_R,obsatacle_L;			//红外避障
extern u8 Flag_Red;   //红外避障标志位
...
extern int Motor_A,Motor_B,Servo,Target_A,Target_B,Speed_Target;  //电机PWM变量 应是Motor的 向Moto致敬	
...
extern float Position_KP,Position_KI,Position_KD;  //Position_PID
